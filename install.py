...
url="https://api.github.com/repos/uatel/space_clock/git/trees/main?recursive=1"
animation_enable = -1
...
if wifiCfg.wlan_sta.isconnected():
  image0.set_network_img_src("https://raw.githubusercontent.com/uatel/space_clock/main/resources/install_download.png")
  ...
  def playAlarm():
    ...
    img=[]
    for i in range(0,3):
      img.append(M5Img("https://raw.githubusercontent.com/uatel/space_clock/main/resources/install_download_pr_{}.png".format(i), x=128, y=64, parent=None))
    wait(0.1)
    animation_enable = 3
      ...
      for i,d in enumerate(data["tree"]):
        ...
        if d["type"]=="blob":
          ...
          if not (path in ignore) and path[0]!="." and path[:path.find("/")]!="resources":
            ...
            file_d = urequests.request(method="GET", url="https://raw.githubusercontent.com/uatel/space_clock/main/{}".format(path), headers={ 'User-Agent': 'M5Stack'})
